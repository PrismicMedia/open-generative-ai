...
export default function AppsStudio({ apiKey }) {
  ...
  // Close the Get Template modal on Escape
  useEffect(() => {
          ...
          <div className="relative bg-[#0a0a0a] border border-white/10 w-full max-w-md rounded-2xl p-8 space-y-8 animate-scale-up shadow-2xl">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-4 bg-primary text-black rounded-md text-sm font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-primary/90 transition-all shadow-lg active:scale-95 disabled:opacity-50 disabled:active:scale-100"
              >
